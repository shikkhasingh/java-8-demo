...
//		for(int i = 0; i < maxElements; i++) { numberAr.add(i); }
		...
		IntStream intStr = IntStream.rangeClosed(0, maxElements);


		List<Integer> numberAr = new ArrayList<>(IntStream.rangeClosed(0, maxElements).mapToObj(i -> i).collect(Collectors.toList()));
